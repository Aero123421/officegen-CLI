...
export declare function validateInputPath(context: RuntimeContext, inputPath: string): Promise<string>;
...
export declare function readInputJson(context: RuntimeContext, inputPath: string): Promise<unknown>;
export declare function readInputJsonIfPresent(context: RuntimeContext, inputPath: string | undefined): Promise<unknown>;
