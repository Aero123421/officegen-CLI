...
function enrichPathFailureDetails(code: string, details: Record<string, unknown>, requestedPath: string): Record<string, unknown> {
  if (code !== "SECURITY_ABSOLUTE_OUT_DENIED") return details;
