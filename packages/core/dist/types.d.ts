...
export declare const OFFICEGEN_CLI_VERSION = "4.0.0";
...
export type FeatureName = "capabilities" | "help" | "config" | "doctor" | "inspect" | "view" | "edit" | "render" | "scaffold" | "export" | "validate" | "verify" | "diagnose" | "repair" | "diff" | "prepare" | "manifest" | "select" | "plan" | "rollback" | "lock" | "merge" | "run" | "critique" | "improve" | "benchmark" | "asset" | "chart" | "diagram" | "schema" | "errors" | "template" | "design" | "layout" | "agent" | "mcp" | "renderer" | "plugin";
...
export type OfficegenErrorCode = "FEATURE_DISABLED" | "FEATURE_NOT_IMPLEMENTED" | "FEATURE_HIDDEN_FROM_AGENT" | "UNKNOWN_COMMAND" | "UNKNOWN_OPTION" | "OPTION_NOT_EFFECTIVE" | "CAPABILITIES_STALE" | "INPUT_NOT_FOUND" | "INPUT_PARSE_ERROR" | "SCHEMA_INVALID" | "SCHEMA_DEPRECATED" | "SCHEMA_MIGRATION_REQUIRED" | "SECURITY_PATH_OUTSIDE_ROOT" | "SECURITY_ABSOLUTE_OUT_DENIED" | "SECURITY_SYMLINK_DENIED" | "SECURITY_HARDLINK_DENIED" | "SECURITY_INPUT_TOO_LARGE" | "SECURITY_EXTERNAL_PROCESS_DENIED" | "SECURITY_ZIP_BOMB_DETECTED" | "SECURITY_XML_ENTITY_DENIED" | "SECURITY_MACRO_DETECTED" | "SECURITY_RISKY_OOXML_DETECTED" | "BENCHMARK_MANIFEST_PATH_DENIED" | "PLUGIN_NOT_TRUSTED" | "PLUGIN_HASH_MISMATCH" | "PLUGIN_PERMISSION_DENIED" | "RENDERER_NOT_TRUSTED" | "SELECTOR_NOT_FOUND" | "SELECTOR_AMBIGUOUS" | "EDIT_TRANSACTION_FAILED" | "EXPECTED_ARTIFACT_MISSING" | "REPAIR_NO_SAFE_OPS" | "RUN_STEP_FAILED" | "TIMEOUT" | "OOXML_VALIDATION_FAILED" | "IDEMPOTENCY_REPLAY" | "TEXT_OVERFLOW" | "IMAGE_MISSING" | "ASSET_UNSUPPORTED_FORMAT" | "CHART_SPEC_INVALID" | "DIAGRAM_SPEC_INVALID" | "VIEW_FIDELITY_LOW" | "RENDER_FONT_UNSUPPORTED" | "TARGET_EXTENSION_MISMATCH" | "UNSUPPORTED_FORMAT" | "TEMPLATE_FILL_FAILED" | "TEMPLATE_VALIDATE_FAILED" | "DESIGN_NOT_INITIALIZED" | "EXPORT_UNSUPPORTED";
