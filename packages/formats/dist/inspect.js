import { AGENT_UNTRUSTED_INSTRUCTION, getLoadedZipSafetyReport, loadZip, makeStableObjectId, normalizeInput, sortedZipFiles, trustedMeta, zipSafetyCaveats } from "./shared.js";
...
async function inspectPdf(input) {
    ...
    return {
        schema: "officegen.inspect.result@1.2",
        trusted: trustedMeta("officegen.inspect.result@1.2", input, { pages: pages.length }, ["PDF text extraction is not implemented in the MVP inspect path."]),
        untrusted: { pages },
        objectMap: [],
        agentInstruction: AGENT_UNTRUSTED_INSTRUCTION
    };
