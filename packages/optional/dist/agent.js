...
import { featureRoot, normalizeCapabilities, nowIso, requireFeature, slugify, untrustedContentWarning, writeJsonFile } from "./common.js";
export async function installAgentAdapter(options) {
    return writeAgentAdapter(options, "install");
}
export async function refreshAgentAdapter(options) {
...
async function writeAgentAdapter(options, operation) {
