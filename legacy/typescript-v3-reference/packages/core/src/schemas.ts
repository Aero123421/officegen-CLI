...
const envelopeV2Schema: JsonObject = {
  ...envelopeSchema,
...
const capabilityContractSchema: JsonObject = {
  type: "object",
...
const runtimeProfileCapabilitySchema: JsonObject = {
  type: "object",
...
const runtimeProfileSchema: JsonObject = {
  type: "object",
...
const capabilitiesSchema: JsonObject = {
...
const objectGraphRiskFlagSchema: JsonObject = {
  type: "object",
...
const objectGraphEvidenceSchema: JsonObject = {
  type: "object",
...
const objectGraphSourceSchema: JsonObject = {
  type: "object",
  additionalProperties: true,
  properties: {
    format: { type: "string" },
...
const objectGraphNodeSchema: JsonObject = {
  type: "object",
...
const objectGraphEdgeSchema: JsonObject = {
  type: "object",
...
const objectGraphSchema: JsonObject = {
...
const selectorResolutionV2Schema: JsonObject = {
...
const sourceFingerprintSchema: JsonObject = {
  type: "object",
...
const editPlanV2Schema: JsonObject = {
...
const patchPlanV2Schema: JsonObject = {
...
const officeAgentPhaseSchema: JsonObject = {
  type: "object",
...
const officeAgentManifestV31Schema: JsonObject = {
...
const officeAgentResultV31Schema: JsonObject = {
...
const officeAgentWorkflowV31Schema: JsonObject = {
...
const verifyGatesSchema: JsonObject = {
...
const verificationReportV2Schema: JsonObject = {
